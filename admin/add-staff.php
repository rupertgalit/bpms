...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblstaff(Name,Staff_No,Staff_Name,Mobile_No) value('$name','$staffno','$staff_name','$mobilenum')");
    if ($query) {
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Staff No.</label> <input type="text" id="staffno" name="staffno" class="form-control" placeholder="Staff no." value="" required="true"> </div>
							 <div class="form-group"> <label for="exampleInputEmail1">Staff Name</label> <input type="text" class="form-control" id="staff_name" name="staff_name" placeholder="Staff Name" value="" required="true"> </div> 
