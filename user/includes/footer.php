          ...
          <div class="col-md" style="padding-left: 150px">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="user/about.php" class="py-2 d-block">About</a></li>
                <li><a href="user/services.php" class="py-2 d-block">Services</a></li>
...
?>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  2022 &copy; Rowena Salon Management System  </p>
          </div>
        </div>
      </div>
    </footer>